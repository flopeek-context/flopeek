...
pub(super) use calls::{ResolutionContext, ResolutionOutcome, resolve_calls, resolve_heritage};
...
pub use targets::resolution_evidence;
pub(super) use targets::{
    callable_candidates, coalesce_resolutions, combine_outcomes, resolve_export,
    resolve_external_or_unresolved, resolve_import_module, resolve_import_target,
    unique_or_unresolved, unresolved, unresolved_with_candidates, unresolved_with_status,
};
