...
pub const PRODUCT_CONTRACT_SCHEMA: &str = "flopeek-product-contract/v11";
pub const GRAPH_SCHEMA: &str = "flopeek-graph/v7";
pub const CONTEXT_REF_SCHEMA: &str = "flopeek-context-ref/v4";
pub const PROTOCOL_SCHEMA: &str = "flopeek-protocol/v15";
pub const STORE_SCHEMA: &str = "flopeek-sqlite/v11";
...
pub const DIAGNOSTIC_CONTEXT_SCHEMA: &str = "flopeek-diagnostic-context/v7";
...
pub const HISTORICAL_DIAGNOSIS_SCHEMA: &str = "flopeek-historical-diagnosis/v7";
pub const DIAGNOSTIC_PACKET_SCHEMA: &str = "flopeek-diagnostic-packet/v10";
...
pub const LAST_KNOWN_GOOD_SCHEMA: &str = "flopeek-last-known-good/v2";
