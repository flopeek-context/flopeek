...
pub fn build_packet(
    ...
    let mut packet = DiagnosticPacket {
        ...
        last_known_good_candidate: historical.last_known_good_candidate.clone(),
        last_known_good_state: historical.last_known_good_state.clone(),
        last_known_good_applicability: historical.last_known_good_applicability.clone(),
        focus_context_refs,
        focus_flow_refs,
        focus_nodes,
        focus_flows,
