...
mod architecture_contract_tests {
    ...
    fn public_core_contract_paths_remain_stable() {
        ...
        assert_eq!(crate::model::PROTOCOL_SCHEMA, "flopeek-protocol/v15");
    ...
    fn persistence_and_diagnostic_contract_paths_remain_stable() {
        assert_eq!(crate::store::CURRENT_USER_VERSION, 13);
        assert_eq!(
            crate::model::PRODUCT_CONTRACT_SCHEMA,
            "flopeek-product-contract/v11"
        );
        assert_eq!(
            crate::model::LKG_CANDIDATE_SCHEMA,
            "flopeek-last-known-good-candidate/v2"
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            "flopeek-last-known-good-state/v2"
        );
        assert_eq!(
            crate::model::LKG_REVIEW_PACKET_SCHEMA,
            "flopeek-last-known-good-review-packet/v2"
        );
        assert_eq!(
