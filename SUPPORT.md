...
This generated/current implementation reference describes **what the inherited
Flopeek implementation currently analyzes and what each result means**. It is
subordinate to [AGENTS.md](AGENTS.md), the single human-readable authority.

For V1 product scope and trust rules, follow AGENTS.md. Historical roadmap and
product documents do not override it.
...
- Public package and GitHub release promotion are blocked until canonical publication authority is explicitly approved.
